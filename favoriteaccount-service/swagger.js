...
const options = {
    definition: {
        openapi: '3.0.0',
        info: {
            title: 'PaySmart - Favorite Account Service API',
            version: 'v1',
            description: 'API de gestion de cuentas favoritas y transferencias rapidas para PaySmart.',
            contact: {
                name: 'FazeCode'
            }
        },
    ...
    apis: ['./src/favoriteaccounts/favoriteAccount.routes.js']
};
