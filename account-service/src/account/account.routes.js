...
import {  createAccount, getMyAccounts, getBalance, getBalanceInternal, updateBalanceInternal, getAccountsByEmailController, deactivateAccount, activateAccount, suspendAccount, adminCreateAccountForUser} from './account.controller.js';
import { validateCreateAccount } from '../../middlewares/account-validator.js';
import { validateJWT } from '../../middlewares/validate-JWT.js';
import { validateInternalApiKey } from '../../middlewares/validate-internal-key.js';
 ...
 *     description: Requiere header X-Internal-Api-Key con el secreto compartido entre servicios.
 *     parameters:
 *       - in: path
 *         name: accountNumber
 *         required: true
 ...
 *       401:
 *         description: API Key interna requerida.
 *       403:
 *         description: API Key interna inválida.
 *       404:
 ...
 *     description: Requiere header X-Internal-Api-Key. Soporta tipo DEPOSIT para sumar y WITHDRAW para restar.
 *     parameters:
 *       - in: path
 *         name: accountNumber
 *         required: true
